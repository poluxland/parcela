...
class BudgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget" do
    assert_difference('Budget.count') do
      post budgets_url, params: { budget: { descripcion: @budget.descripcion, nombre: @budget.nombre, valor: @budget.valor } }
    end
  ...
  test "should update budget" do
    patch budget_url(@budget), params: { budget: { descripcion: @budget.descripcion, nombre: @budget.nombre, valor: @budget.valor } }
